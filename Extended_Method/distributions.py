"""
All code in this file is adapted from that published in 
conjunction with the research article Erhardt, T. et al. 
Decadal-scale progression of the onset of Dansgaard-Oeschger
warming events. Clim. Past 15, 811–825 (2019) and
available from https://github.com/terhardt/DO-progression
------------------------------------------------------------------
...
Distribution and likelihood functions """
...
def sample_ar1(n, alpha, sigma=1.0, x0=0):
    """Generate AR(1) noise for evenly sampled series"""
    x = np.zeros(n)
